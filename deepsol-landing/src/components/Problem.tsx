      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 w-full max-w-4xl mx-auto">
        {problems.map((problem, idx) => (
          <motion.article
            ...
            className="flex flex-col items-start bg-white/60 border border-white/40 rounded-2xl p-4 sm:p-8 gap-2 sm:gap-4 h-full justify-between shadow-xl backdrop-blur-md transition-transform duration-300 hover:scale-105 hover:shadow-blue-200/70 hover:ring-2 hover:ring-blue-200/60"
          >
