      ...
      <div className="mx-auto max-w-6xl text-center w-full relative z-10 py-12 sm:py-16 md:py-20">
        ...
        >
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight sm:leading-tight md:leading-tight lg:leading-tight mb-4 sm:mb-6 bg-gradient-to-r from-[#2563eb] via-[#38bdf8] to-[#60a5fa] bg-clip-text text-transparent max-w-6xl mx-auto"
          >
            NO.1 AI 에듀테크 Studio
          </motion.h1>
          <motion.p
            className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl leading-7 sm:leading-8 text-gray-600 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
